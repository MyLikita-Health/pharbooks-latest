  ...
  const conversations = [
    {
      id: 1,
      name: "Jane Patient",
      lastMessage: "When will my prescription be ready for pickup?",
      time: "30 minutes ago",
      unread: 1,
    },
    {
      id: 2,
      name: "Dr. Sarah Smith",
      lastMessage: "Please verify the dosage for patient John Smith's prescription.",
      time: "2 hours ago",
      unread: 2,
    },
  ]
    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-purple-900">Messages</h1>
            <p className="text-gray-600">Communicate with patients and healthcare providers</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card className="lg:col-span-2">
            <CardHeader>
              ...
              <CardDescription>Patient inquiry</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="bg-gray-100 rounded-lg p-3 max-w-xs">
                      <p className="text-sm">When will my prescription be ready for pickup?</p>
